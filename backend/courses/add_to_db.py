...
"""
with open("./recommendor/cs_major_courses.json") as f:
...
# add ny electives
with open("./recommendor/ny_elective_courses.json") as f:
    course_lists = json.load(f)
...
# add ny core
with open("./recommendor/ny_core_courses.json") as f:
    course_lists = json.load(f)
# pprint(course_lists)
...
# add sh core
with open("./recommendor/sh_core_courses.json") as f:
    course_lists = json.load(f)
# pprint(course_lists)
course_lists["IPC/HPC/SSPC"] = course_lists["IPC"] + course_lists["HPC"] + course_lists["SSPC"]
